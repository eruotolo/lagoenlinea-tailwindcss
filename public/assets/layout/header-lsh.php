<header id="header-principal" class="md:h-[70px] 3xl:h-[100px] py-2 ">
    <div class="container">
        <nav id="navbar" class="fixed md:h-[70px] 3xl:h-[100px] top-0 z-40 flex w-full flex-row justify-end sm:justify-between items-center bg-[#6A88B4]">
            ...
            <div class="logo">
                <a href="index.php"><img src="assets/img/logo_img_wh.svg" alt="Logo" class="md:h-[50px] 3xl:h-[70px]"></a>
            </div>
            <div class="logo-lsh">
                <a href="index.php"><img src="assets/img/lagosinhuella/logo-wh.svg" alt="Logo Lago Sin Huella" class="md:h-[60px] 3xl:h-[80px]"></a>
            </div>
            <div class="muni-ptovaras">
                <img src="assets/img/lagosinhuella/muni-ptovaras.svg" alt="Logo Municipalidad" class="md:h-[50px] 3xl:h-[70px]">
            </div>
