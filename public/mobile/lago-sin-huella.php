    ...
    <section>
        ...
        <div class="container sponsor">
            ...
            <div class="sponsor-logos text-center">
                <img src="assets/img/lagosinhuella/sponsor-01.webp" alt="Sponsor 01" style="width: 300px" class="img-fluid">
            </div>
            <p>Aportantes:</p>
            <div class="sponsor-logos text-center">
                <img src="assets/img/lagosinhuella/sponsor-02.webp" alt="Sponsor 01" style="width: 300px" class="img-fluid">
                <img src="assets/img/lagosinhuella/sponsor-03.webp" alt="Sponsor 01" style="width: 300px" class="img-fluid">
                <img src="assets/img/lagosinhuella/sponsor-04.webp" alt="Sponsor 01" style="width: 300px" class="img-fluid">
            </div>
        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                            <div class="accordion-body text-center accordion-contenido">
                                ...
                                <p>Busca monitorear en forma permanente la bahía de Puerto Varas para, por un lado, establecer un criterio de transparencia en relación al estado actual del Lago y evaluar cómo se puede ir mejorando la situación 		hacia el futuro y, por otro lado, contribuir a que la comunidad pueda escoger los puntos de uso de las playas urbanas de forma más segura.</p>
                                <img src="../assets/img/lagosinhuella/lagosinhuella-03.webp" alt="imagen 01" class="img-fluid">
                                <img src="../assets/img/lagosinhuella/lagosinhuella-04.webp" alt="imagen 01" class="img-fluid">
                                <img src="../assets/img/lagosinhuella/lagosinhuella-05.webp" alt="imagen 01" class="img-fluid">
                            </div>
                        </div>
                    </div>
